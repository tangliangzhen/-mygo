...
class GO2Cfg_Duijiaostand( LeggedRobotCfg ):
    ...
    class init_state( LeggedRobotCfg.init_state ):
        ...
        descire_joint_angles = { # = target angles [rad] when action = 0.0
            'FL_hip_joint': 0.1,   # [rad]
            'RL_hip_joint': 0.4,   # [rad]
            'FR_hip_joint': -0.4,  # [rad]
            'RR_hip_joint': -0.1,   # [rad]

            'FL_thigh_joint': 0.5,     # [rad]
            'RL_thigh_joint': 1.57,#1.,   # [rad]
            'FR_thigh_joint': 1.57,     # [rad]
            'RR_thigh_joint': 0.6,#1.,   # [rad]
    ...
    class asset:
        ...
        feet_name_reward=['FR_foot', 'RL_foot']
        contact_foot=['FL_foot', 'RR_foot']
    ...
    class rewards:
        class scales:
            ...
            lin_vel_z = 0.2
            ang_vel_xy = 0.2
            duijiaostand_orientation = -1.0
            torques = -0.0002
            dof_vel = -0.
            dof_acc = -2.5e-4
            base_height = 1.5
            duijiaostand_feet_on_air =  2.0
            collision = -2.
            feet_stumble = -0.0 
            action_rate = -0.05
            default_pos =-0.1####
            ...
            duijiaostand_feet_height_exp=5.0
...
class GO2CfgPPO_Duijiaostand(LeggedRobotCfgPPO):
    seed = 1
    ...
    class runner:
        ...
        experiment_name = 'go2_duijiaostand'
        run_name = ''
        # load and resume
        resume = False
