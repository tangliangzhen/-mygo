...
class GO2Cfg_Sidestand( LeggedRobotCfg ):
    ...
    class asset:
        ...
        feet_name_reward=['FR_foot', 'RR_foot']
        contact_foot=['FL_foot', 'RL_foot']
    ...
    class rewards:
        class scales:
            ...
            lin_vel_z = 0.2
            ang_vel_xy = 0.2
            sidestand_orientation = -3.0
            torques = -0.001
            dof_vel = -0.
            dof_acc = -2.5e-4
            base_height = 2.0
            sidestand_feet_on_air =  2.0
            collision = -2.
            feet_stumble = -0.0 
            action_rate = -0.1
            default_pos =-0.1####
...
class GO2CfgPPO_Sidestand(LeggedRobotCfgPPO):
    seed = 1
