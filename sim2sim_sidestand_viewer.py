from legged_gym.envs.GO2_Stand.GO2_Sidestand.Go2_sidestand_Config import GO2Cfg_Sidestand
import math
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model', type=str, default="logs/go2_sidestand/exported/policies/policy_1.pt",help='Run to load from.')
    parser.add_argument('--terrain', action='store_true', help='terrain or plane')
    args = parser.parse_args()

    class Sim2simCfg(GO2Cfg_Sidestand):
        class sim_config:
